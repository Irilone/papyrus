...
$(document).ready(function () {
  ...
  $(document).on("click", "#addComment", function () {
    ...
    var inputForm = $(
      '<div class="comment-input-form" style="position: absolute; left:' +
        rightClickX +
        "px; top:" +
        rightClickY +
        'px;"><input type="text" id="floatingCommentInput" placeholder="Enter your comment..."><button id="submitFloatingComment">Submit</button></div>',
    );
...
$(document).on("click", "#addSticker", function (e) {
  ...
  var placeholderSticker = $("<div></div>")
    .addClass("sticker placeholder")
    .css({
      position: "absolute",
  ...
  var colorInput = $(
    '<input type="color" id="stickerColorPicker" style="display:none;">',
  ).appendTo("body");
