...
const sidebarItems = [{
        name: "Library",
        icon: '/img/icons/sidepanel/library.svg'
    },
    {
        name: 'Starred Papers',
        icon: '/img/icons/sidepanel/star.svg'
    },
    {
        name: 'Archived Papers',
        icon: '/img/icons/sidepanel/stack.svg'
    },
    {
        name: 'Bookmarked Papers',
        icon: '/img/icons/sidepanel/bookmark.svg'
    },

    {
        icon: '/img/UI/divider.svg'
    },

    {
        name: 'Collections',
        icon: '/img/icons/sidepanel/folders.svg'
    },
    {
        name: 'Thesis Project',
        icon: '/img/icons/sidepanel/hat.svg'
    },
    {
        name: 'Project X',
        icon: '/img/icons/sidepanel/stack2.svg'
    },
    {
        name: 'Project Y',
        icon: '/img/icons/sidepanel/layers.svg'
    },
...

    {
        ...
        icon: '/img/icons/sidepanel/recent.svg'
    },
    {
        name: 'Recently read papers',
        icon: '/img/icons/sidepanel/recentread.svg'
    },
    {
        name: 'Recent searches',
        icon: '/img/icons/sidepanel/recentsearch.svg'
    },
    ...
    {
        name: 'Types of paper',
        icon: '/img/icons/sidepanel/typesofpap.svg'
    },
    {
        name: 'Experiments',
        icon: '/img/icons/sidepanel/experiments.svg'
    },
    {
        name: 'Literature Review',
        icon: '/img/icons/sidepanel/litrev.svg'
    },
    {
        name: 'Opinion',
        icon: '/img/icons/sidepanel/opinion.svg'
    },
    {
        name: 'Theory',
        icon: '/img/icons/sidepanel/theory.svg'
    },
    {
        name: 'Introduction',
        icon: '/img/icons/sidepanel/intro.svg'
    },
    // ... more sidebar items
